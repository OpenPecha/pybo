...
parser_to_try = (
    ("མིང་ཚིག ཀཀ། ཁཁ། གག།", [("མིང་ཚིག", "ཀཀ། ཁཁ། གག།")], [("མིང་ཚིག", "ཀཀ། ཁཁ། གག།")]),
    (
        "མིང་ཚིག 1. ཀཀ། 2. ཁཁ། 3. གག།",
        [("མིང་ཚིག", "ཀཀ། 2. ཁཁ། 3. གག།")],
        [("མིང་ཚིག", "ཀཀ།"), ("མིང་ཚིག", "ཁཁ།"), ("མིང་ཚིག", "གག།")],
    ),
    (
        "མིང་ཚིག 1. ཀཀ། 2. ཁཁ། བྱེད་ཚིག 1. ཀཀ། 2. ཁཁ། གྲོགས་ཚིག ཀཀ། ཁཁ། བྱེད་ཚིག ཀཀ། ཁཁ།",
        [
            ("མིང་ཚིག", "ཀཀ། 2. ཁཁ།"),
            ("བྱེད་ཚིག", "ཀཀ། 2. ཁཁ།"),
            ("གྲོགས་ཚིག", "ཀཀ། ཁཁ།"),
